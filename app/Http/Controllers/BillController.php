...
class BillController extends Controller
{
    ...
    /* ---------- Shop ---------- */
        ...
        //     // Lấy thông tin vận chuyển cho mỗi đơn đặt hàng
        //     foreach ($list_bill as $bill) {
        //         $ShippingUnit = ShippingUnit::where('bill_id', $bill->idBill)->first();
        //         // Thêm thông tin vận chuyển vào đối tượng đơn đặt hàng
        //         $bill->ShippingUnit = $ShippingUnit;
        //     }
