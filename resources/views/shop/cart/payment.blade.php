        ...
        <div class="container__address">
            ...
            <div class="container__address-content">
                ...
                <ul class="shipping-list list-address">
                    <li>
                        <div class="mb-3">
                            <!-- Tạo phần tử <select> để hiển thị danh sách nhà cung cấp -->
                            <select name="provider" class="form-control">
                                <!-- Lặp qua danh sách nhà cung cấp -->
                                @foreach($list_provide as $provider)
                                    <!-- Tạo một tùy chọn <option> cho mỗi nhà cung cấp -->
                                    <option value="{{ $provider->id }}"> <!-- Sử dụng giá trị của khóa chính hoặc giá trị tương ứng -->
                                        {{ $provider->name }} <!-- Hiển thị tên của nhà cung cấp -->
                                    </option>
                                @endforeach
                            </select>
                        </div>
